...
namespace lilToon.PCSS.Editor
{
    ...
    public class UnifiedPCSSMenuSystem : EditorWindow
    {
        ...
        // [MenuItem("Tools/lilToon-PCSS-Extension/nHaruka互換システム/ワンクリックセットアップ", priority = 10)]
        public static void OpenSetupWizard()
        {
            ModularAvatarPCSSSetupWizard.ShowWindow();
        }
        // [MenuItem("Tools/lilToon-PCSS-Extension/nHaruka互換システム/ワンクリックセットアップ", true)]
        private static bool ValidateOpenSetupWizard()
        {
            return HasVRChatSDK() && HasLilToon();
        }
        
        // [MenuItem("Tools/lilToon-PCSS-Extension/nHaruka互換システム/PhysBone制御設定", priority = 20)]
        public static void OpenPhysBoneControl()
        {
            PhysBoneLightControlWindow.ShowWindow();
        }
        // [MenuItem("Tools/lilToon-PCSS-Extension/nHaruka互換システム/PhysBone制御設定", true)]
        private static bool ValidateOpenPhysBoneControl()
        {
            return HasVRChatSDK();
        }
        
        // [MenuItem("Tools/lilToon-PCSS-Extension/nHaruka互換システム/ModularAvatar統合設定", priority = 30)]
        public static void OpenModularAvatarIntegration()
        {
            ModularAvatarIntegrationWindow.ShowWindow();
        }
        // [MenuItem("Tools/lilToon-PCSS-Extension/nHaruka互換システム/ModularAvatar統合設定", true)]
        private static bool ValidateOpenModularAvatarIntegration()
        {
            return HasVRChatSDK();
        }
        
        // [MenuItem("Tools/lilToon-PCSS-Extension/nHaruka互換システム/パフォーマンス最適化", priority = 40)]
        public static void OpenPerformanceOptimization()
        {
            PerformanceOptimizationWindow.ShowWindow();
        }
        // [MenuItem("Tools/lilToon-PCSS-Extension/nHaruka互換システム/パフォーマンス最適化", true)]
        private static bool ValidateOpenPerformanceOptimization()
        {
            return true;
        }
        
        // [MenuItem("Tools/lilToon-PCSS-Extension/nHaruka互換システム/高度なプリセット管理", priority = 90)]
        public static void OpenAdvancedPresetManagement()
        {
            AdvancedPCSSMenuSystem.ShowWindow();
        }
        // [MenuItem("Tools/lilToon-PCSS-Extension/nHaruka互換システム/高度なプリセット管理", true)]
        ...
        // [MenuItem("Tools/lilToon-PCSS-Extension/nHaruka互換システム/競合製品互換性設定", priority = 100)]
        public static void OpenCompetitorCompatibility()
        {
            CompetitorSetupWizard.ShowWindow();
        }
        // [MenuItem("Tools/lilToon-PCSS-Extension/nHaruka互換システム/競合製品互換性設定", true)]
        ...
        public class PhysBoneLightControlWindow : EditorWindow
        {
            ...
            [MenuItem("Tools/lilToon-PCSS-Extension/Dashboard %#D", priority = 10)]
            ...
            [MenuItem("Tools/lilToon-PCSS-Extension/Dashboard", true)]
            ...
            [MenuItem("Tools/lilToon-PCSS-Extension/nHaruka互換システム/PhysBone制御設定")]
        ...
        public class ModularAvatarIntegrationWindow : EditorWindow
        {
            ...
            [MenuItem("Tools/lilToon-PCSS-Extension/nHaruka互換システム/ModularAvatar統合設定")]
            public static void ShowWindow()
            {
        ...
        public class PerformanceOptimizationWindow : EditorWindow
        {
            ...
            [MenuItem("Tools/lilToon-PCSS-Extension/nHaruka互換システム/パフォーマンス最適化")]
            public static void ShowWindow()
            {
