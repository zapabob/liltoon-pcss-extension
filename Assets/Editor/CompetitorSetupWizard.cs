    ...
    public class PhysBoneLightController : MonoBehaviour
    {
        ...
        private void ApplySettings()
        {
            ...
            if (useExternalLight)
            {
                ...
                {
                    EditorUtility.DisplayDialog("繧ｨ繝ｩ繝ｼ", "螟夜Κ繝ｩ繧､繝医′險ｭ螳壹＆繧後※縺・∪縺帙ｓ縲・, "OK");
                    return;
                }
                pcssLight = externalLightObject;

                // 繧ｳ繝ｳ繝医Ο繝ｼ繝ｩ繝ｼ逕ｨ縺ｮ繧ｪ繝悶ず繧ｧ繧ｯ繝医ｒ繧｢繝舌ち繝ｼ逶ｴ荳九↓菴懈・
            ...
            else
            {
                ...
                controller.externalLight = null; // 螟夜Κ繝ｩ繧､繝医Δ繝ｼ繝峨〒縺ｪ縺・％縺ｨ繧呈・遉ｺ
            }
            ...
            // 繝槭ユ繝ｪ繧｢繝ｫ縺ｮ險ｭ螳壼､画峩蜃ｦ逅・
            ApplyMaterialSettings(targetObject, selectedPreset, useShadowMask);

            EditorUtility.DisplayDialog("謌仙粥", $"縲鶏targetObject.name}縲阪↓PCSS繝ｩ繧､繝医・險ｭ螳壹ｒ驕ｩ逕ｨ縺励∪縺励◆縲・n繝励Μ繧ｻ繝・ヨ: {selectedPreset}", "OK");
        }
