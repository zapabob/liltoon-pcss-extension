...
{
    [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat/All-in-One/1) Import PCSS UnityPackage...")]
    ...
    [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat/All-in-One/2) Apply lilToon PCSS to All Materials")]
    public static void ApplyPCSSAll()
    {
        ApplyToAllMaterials(preferPCSS: true);
    }

    [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat/Apply lilToon to Selected Materials")]
    ...
    [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat/Apply lilToon to All Materials in Project")]
    ...
    [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat/Reimport Selected Models with External Materials")]
