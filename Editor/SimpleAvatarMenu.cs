...
namespace lilToon.PCSS.Editor
{
    ...
    {
        private const string DefaultMenuRoot = "Tools/lilToon-PCSS-Extension/Legacy/Quick Add";
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/Open Setup Wizard", priority = 50)]
