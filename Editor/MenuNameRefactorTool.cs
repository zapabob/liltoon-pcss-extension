...
{
    private const string MenuRoot = "Tools/lilToon-PCSS-Extension/Legacy/";

    [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/Utilities/Refactor Menu Names", priority = 9999)]
    public static void RefactorMenuNames()
    {
        ...
        foreach (var file in files)
        {
            ...
            // 例: Tools/lilToon PCSS/ → Tools/lilToon-PCSS-Extension/Legacy/
            text = Regex.Replace(text, @"MenuItem\(""Tools/lilToon-PCSS-Extension/Legacy/", $"MenuItem(\"{MenuRoot}");
            text = Regex.Replace(text, @"MenuItem\(""Tools/lilToon-PCSS-Extension/Legacy/", $"MenuItem(\"{MenuRoot}");
            text = Regex.Replace(text, @"MenuItem\(""Tools/lilToon-PCSS-Extension/Legacy/", $"MenuItem(\"{MenuRoot}");
            text = Regex.Replace(text, @"MenuItem\(""Tools/lilToon-PCSS-Extension/Legacy/", $"MenuItem(\"{MenuRoot}");
            text = Regex.Replace(text, @"MenuItem\(""Tools/lilToon-PCSS-Extension/Legacy/", $"MenuItem(\"{MenuRoot}");
            ...
            text = Regex.Replace(text, @"""Tools/lilToon-PCSS-Extension/Legacy/", $"\"{MenuRoot}");
            text = Regex.Replace(text, @"""Tools/lilToon-PCSS-Extension/Legacy/", $"\"{MenuRoot}");
            text = Regex.Replace(text, @"""Tools/lilToon-PCSS-Extension/Legacy/", $"\"{MenuRoot}");
            text = Regex.Replace(text, @"""Tools/lilToon-PCSS-Extension/Legacy/", $"\"{MenuRoot}");
            text = Regex.Replace(text, @"""Tools/lilToon-PCSS-Extension/Legacy/", $"\"{MenuRoot}");
