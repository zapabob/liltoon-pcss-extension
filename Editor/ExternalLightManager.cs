...
namespace lilToon.PCSS.Editor
{
    ...
    public class ExternalLightManager : EditorWindow
    {
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/外部ライト管理")]
