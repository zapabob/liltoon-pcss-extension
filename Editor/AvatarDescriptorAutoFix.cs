...
namespace lilToon.PCSS.Editor
{
    ...
    {
#if VRC_SDK_VRCSDK3
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat向けクリーンアップ/AvatarDescriptor: Custom Layer空設定を無効化", false, 300)]
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat向けクリーンアップ/PreValidation: Deep Fix Animator/Expressions", false, 301)]
