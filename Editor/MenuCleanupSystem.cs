...
namespace lilToon.PCSS.Editor
{
    ...
    public static class MenuCleanupSystem
    {
        ...
        private static readonly string[] HiddenMenus = new string[]
        {
            ...
            "Tools/lilToon-PCSS-Extension/Legacy/リアル風セット適用",
            "Tools/lilToon-PCSS-Extension/Legacy/アニメ風セット適用", 
            "Tools/lilToon-PCSS-Extension/Legacy/映画風セット適用",
            "Tools/lilToon-PCSS-Extension/Legacy/ポートレート風セット適用",
            "Tools/lilToon-PCSS-Extension/Legacy/ゲーム風セット適用",
            
            // 個別の管理メニュー（統合メニューに移行）
            "Tools/lilToon-PCSS-Extension/Legacy/統合プリセット管理",
            "Tools/lilToon-PCSS-Extension/Legacy/高度な統合プリセット管理",
            
            // 重複するメニュー
            "Tools/lilToon-PCSS-Extension/Legacy/外部ライト管理",
            "Tools/lilToon-PCSS-Extension/Legacy/ModularAvatarライト制御",
            "Tools/lilToon-PCSS-Extension/Legacy/ライトトグルメニュー",
            "Tools/lilToon-PCSS-Extension/Legacy/マテリアルアップグレーダー",
            "Tools/lilToon-PCSS-Extension/Legacy/Material Backup/Restore",
            "Tools/lilToon-PCSS-Extension/Legacy/マテリアル自動修復",
            "Tools/lilToon-PCSS-Extension/Legacy/シェーダー自動変換",
            "Tools/lilToon-PCSS-Extension/Legacy/パフォーマンス最適化",
            "Tools/lilToon-PCSS-Extension/Legacy/パフォーマンス最適化メニュー",
            "Tools/lilToon-PCSS-Extension/Legacy/シェーダーコンパイル最適化",
            "Tools/lilToon-PCSS-Extension/Legacy/VRChat最適化設定",
            "Tools/lilToon-PCSS-Extension/Legacy/VRChat式メニュー作成",
            "Tools/lilToon-PCSS-Extension/Legacy/VRChatMaterial Backup/Restore",
            "Tools/lilToon-PCSS-Extension/Legacy/VRChatアップロード自動バックアップ",
            "Tools/lilToon-PCSS-Extension/Legacy/自動Material Backup/Restore",
            "Tools/lilToon-PCSS-Extension/Legacy/セッション復元",
            "Tools/lilToon-PCSS-Extension/Legacy/パッケージエクスポーター",
            "Tools/lilToon-PCSS-Extension/Legacy/手動パッケージエクスポーター",
            "Tools/lilToon-PCSS-Extension/Legacy/ワンクリックセットアップ",
            "Tools/lilToon-PCSS-Extension/Legacy/競合機能実装",
            "Tools/lilToon-PCSS-Extension/Legacy/競合セットアップウィザード",
            "Tools/lilToon-PCSS-Extension/Legacy/アバター選択メニュー",
            "Tools/lilToon-PCSS-Extension/Legacy/高度マスクシステム",
            "Tools/lilToon-PCSS-Extension/Legacy/PhysBoneコライダー作成",
            "Tools/lilToon-PCSS-Extension/Legacy/VRChatライトボリューム",
            "Tools/lilToon-PCSS-Extension/Legacy/VRChatリムライトGUI",
            "Tools/lilToon-PCSS-Extension/Legacy/エラーハンドラー",
            "Tools/lilToon-PCSS-Extension/Legacy/コンパイルチェッカー",
            "Tools/lilToon-PCSS-Extension/Legacy/メニュー名リファクターツール"
        };
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/メニュー整理/古いメニューを非表示化", false, 100)]
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/メニュー整理/統合メニューを推奨", false, 101)]
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/メニュー整理/メニュー状態を確認", false, 102)]
    ...
    {
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/メニュー移行アシスタント", false, 103)]
