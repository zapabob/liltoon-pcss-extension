...
namespace lilToon.PCSS.Editor
{
    ...
    {
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat向けクリーンアップ/不許可コンポーネント削除", false, 200)]
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat向けクリーンアップ/VRC Light Volumes 無効化・除去", false, 201)]
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat向けクリーンアップ/PhysBoneをVRCPhysBoneに統一", false, 202)]
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat向けクリーンアップ/シーン全体: 不許可コンポーネント削除", false, 203)]
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat向けクリーンアップ/プロジェクト全Prefab: 不許可コンポーネント削除", false, 204)]
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat向けクリーンアップ/Missing Script削除(選択アバター)", false, 205)]
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat向けクリーンアップ/Missing Script削除(シーン全体)", false, 206)]
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat向けクリーンアップ/Missing Script削除(全Prefab)", false, 207)]
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat向けクリーンアップ/ModularAvatarPCSSController削除", false, 302)]
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/VRChat向けクリーンアップ/全カスタムPCSSコンポーネント削除", false, 303)]
