...
namespace lilToon.PCSS.Editor
{
    ...
    public class PCSSMenuSystem : EditorWindow
    {
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/統合プリセット管理")]
