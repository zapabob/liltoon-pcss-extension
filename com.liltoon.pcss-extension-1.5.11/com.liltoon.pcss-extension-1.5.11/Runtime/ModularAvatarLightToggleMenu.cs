...
using UnityEditor;
using System.Linq;
// ModularAvatar縺ｮ繧ｳ繧｢蜷榊燕遨ｺ髢・
// ModularAvatar繝代ャ繧ｱ繝ｼ繧ｸ縺瑚ｦ九▽縺九ｉ縺ｪ縺・ｴ蜷医・縲√ヱ繝・こ繝ｼ繧ｸ繝槭ロ繝ｼ繧ｸ繝｣繝ｼ縺ｧ繧､繝ｳ繧ｹ繝医・繝ｫ縺励※縺上□縺輔＞
#if MODULAR_AVATAR
...
public class ModularAvatarLightToggleMenu
{
    ...
    {
#if !MODULAR_AVATAR
        EditorUtility.DisplayDialog("繧ｨ繝ｩ繝ｼ", "ModularAvatar繝代ャ繧ｱ繝ｼ繧ｸ縺後う繝ｳ繧ｹ繝医・繝ｫ縺輔ｌ縺ｦ縺・∪縺帙ｓ縲・nVCC縺九ｉModularAvatar繧偵う繝ｳ繧ｹ繝医・繝ｫ縺励※縺上□縺輔＞縲・, "OK");
        return;
#else
