...
namespace lilToon.PCSS.Editor
{
    ...
    {
        private const string MenuPath = "Tools/lilToon-PCSS-Extension/Legacy/ライト/PhysBoneエミッシブライト作成";
        ...
        public static void CreatePhysBoneEmissiveLight()
        {
            ...
            if (avatar.GetComponent<VRCAvatarDescriptor>() != null)
            {
                ...
                // 手で掴んで動かせるようにする
                pb.allowGrabbing = CreateAdvancedBool(true);
                pb.allowPosing = CreateAdvancedBool(true);
                ...
                var colliders = new System.Collections.Generic.List<VRC.Dynamics.VRCPhysBoneColliderBase>();
                if (leftHand != null)
                {
        ...
        private static VRC.Dynamics.VRCPhysBoneBase.AdvancedBool CreateAdvancedBool(bool defaultValue)
        {
            ...
            {
                // Ignore SDK shape changes; default struct value is acceptable.
            }
            return adv;
        }
