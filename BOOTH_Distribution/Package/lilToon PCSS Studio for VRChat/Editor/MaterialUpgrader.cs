...
namespace lilToon.PCSS.Editor
{
    public class LilToonPCSSMaterialUpgrader2
    {
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/Utilities/lilToon/Upgrade Selected Materials to PCSS Extension v2", true)]
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/Utilities/lilToon/Upgrade Selected Materials to PCSS Extension v2")]
