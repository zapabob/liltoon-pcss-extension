...
namespace lilToon.PCSS
{
    public static class VRChatExpressionMenuCreator
    {
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/Utilities/PCSS Extension/Create VRChat Expression Menu")]
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/Utilities/PCSS Extension/Create VRChat Expression Menu", true)]
