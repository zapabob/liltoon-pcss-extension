...
namespace lilToon.PCSS.Editor
{
    public class LilToonPCSSMaterialUpgrader
    {
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/Utilities/lilToon/Upgrade Selected Materials to PCSS Extension", true)]
        ...
        [MenuItem("Tools/lilToon-PCSS-Extension/Legacy/Utilities/lilToon/Upgrade Selected Materials to PCSS Extension")]
        public static void UpgradeMaterials()
        {
            ...
            {
                EditorUtility.DisplayDialog("アップグレード対象なし", "選択されたマテリアルの中にlilToonシェーダーを使用しているものはありません。", "OK");
                return;
            }
